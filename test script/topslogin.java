...
public class topslogin {
	...
	public class Login {
		static WebDriver driver;
			...
			changePass.click();
			Thread.sleep(2000);
			driver.findElement(By.id("current_password")).sendKeys("123");
			Thread.sleep(1000);
	        ...
	        Thread.sleep(1000);
	        driver.findElement(By.id("programmingLanguages")).sendKeys("Java, JS");
	        Thread.sleep(1000);
	        driver.findElement(By.id("databases")).sendKeys("SQL");
	        Thread.sleep(1000);
	        driver.findElement(By.id("webServers")).sendKeys("Apache");
	        Thread.sleep(1000);
	        driver.findElement(By.id("softwares")).sendKeys("Jira, Bugzilla, Eclipse, postman");
	        Thread.sleep(1000);
	        driver.findElement(By.id("systems")).sendKeys("Windows,Mac");
	        Thread.sleep(1000);
	        ...
	        Thread.sleep(1000);
	        driver.findElement(By.id("referFirstName")).sendKeys("asd");
	        Thread.sleep(1000);
	        driver.findElement(By.id("referLastName")).sendKeys("usdd");
	        Thread.sleep(1000);
	        driver.findElement(By.id("referMobile")).sendKeys("100");
	        Thread.sleep(1000);
